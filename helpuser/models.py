...
class ArHelpFile(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete='models.SET_NULL',related_name='created_by_helpuser')
    created_dt = models.DateTimeField(default=django.utils.timezone.now)
    updated_by = models.ForeignKey(User, on_delete='models.SET_NULL',related_name='updated_by_helpuser')
