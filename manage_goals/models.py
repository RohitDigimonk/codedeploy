...
class ArManageGoals(models.Model):
    ...
    created_by = models.ForeignKey(Ar_user, on_delete='models.SET_NULL', related_name='create_by_ManageGoals')
    created_dt = models.DateTimeField(default=django.utils.timezone.now)
    updated_by = models.ForeignKey(Ar_user, on_delete='models.SET_NULL', related_name='update_by_ManageGoals')
